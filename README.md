...
```
cd existing_repo
git remote add origin https://pacasource.ent.cgi.com/gitlab/apac/divya.eesarla/sppech-to-text-local.git
git branch -M main
...
- [ ] [Set up project integrations](https://pacasource.ent.cgi.com/gitlab/apac/divya.eesarla/sppech-to-text-local/-/settings/integrations)
...
>>>>>>> 984b4639fea861c4ae24f867bc248bc73974dcea
